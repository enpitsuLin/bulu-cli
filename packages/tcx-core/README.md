...
`@bulu-cli/tcx-core` is a Rust-powered N-API package for Ethereum, Tron, and TON wallet management used by the bulu CLI.
...
- Derive Ethereum, Tron, and TON accounts
- Sign Ethereum or Tron messages
- Sign Ethereum, Tron, and TON transactions
